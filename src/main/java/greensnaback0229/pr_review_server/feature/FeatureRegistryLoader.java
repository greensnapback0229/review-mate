...
public class FeatureRegistryLoader {
    ...
    public Map<String, FeatureDefinition> loadFromRepository(String repoFullName, String githubToken) throws IOException {
        log.info("Loading feature registry from repository: {}", repoFullName);
        ...
        try {
            ...
            log.info("Successfully got file content from: {}", REGISTRY_PATH);
            ...
            log.error("Failed to load feature registry from {}: {}", repoFullName, e.getMessage(), e);
            throw e;
        }
    }
